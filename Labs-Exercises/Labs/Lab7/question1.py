...
lat = StringVar() # creates a TK StringVar lat
lat.set("") # sets it blank
lon = StringVar() # Creates a TK StringVar lon
lon.set("") # sets it blank
city_select = StringVar()   # creates a TK StringVar city_select
city_select.set("Select a City") # sets the value 
...
# grids the waether textbox and will span 2 columns
